...
choices_month=[('1','Jan'),('2','Feb'),('3','Mar'),('4','April'),('5','May'),('6','June'),('7','July'),('8','Aug'),('9','Sep'),('10','Act'),('11','Nov'),('12','Dec')]
...
class SampleForm(forms.Form):
    first_name=forms.CharField(max_length=20,required=True,label="First_Name",help_text="Note:Space and special characters are not allowed")
    last_name=forms.CharField(max_length=20,required=False,label="Last_Name")
    email=forms.EmailField(max_length=100,required=True,label="Email")
    phno=forms.IntegerField(max_value=9999999999,min_value=6000000000,required=True,label="Phone No",help_text="NO country codes")
    #phno=forms.RegexField(max_length=10,min_length=10,required=True,regex=r'[6-9]\d{9}')
